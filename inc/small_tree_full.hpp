...
public:
  ...
  virtual float  const & w_fs_lep() const;
  virtual float  & w_fs_lep();
  virtual float  const & w_isr() const;
  virtual float  & w_isr();
  virtual float  const & w_lep() const;
  virtual float  & w_lep();
  virtual float  const & w_lumi() const;
  virtual float  & w_lumi();
  ...
  virtual std::vector<float>  const & sys_fs_bctag() const;
  virtual std::vector<float>  & sys_fs_bctag();
  virtual std::vector<float>  const & sys_fs_lep() const;
  virtual std::vector<float>  & sys_fs_lep();
  virtual std::vector<float>  const & sys_fs_udsgtag() const;
  virtual std::vector<float>  & sys_fs_udsgtag();
  ...
  virtual std::vector<float>  const & sys_met() const;
  virtual std::vector<float>  & sys_met();
  virtual std::vector<float>  const & sys_mj() const;
  virtual std::vector<float>  & sys_mj();
  virtual std::vector<float>  const & sys_mj14() const;
  virtual std::vector<float>  & sys_mj14();
  virtual std::vector<float>  const & sys_mt() const;
  virtual std::vector<float>  & sys_mt();
  ...
  virtual std::vector<float>  const & sys_pdf() const;
  virtual std::vector<float>  & sys_pdf();
  virtual std::vector<float>  const & sys_st() const;
  virtual std::vector<float>  & sys_st();
  virtual std::vector<float>  const & sys_trig() const;
  virtual std::vector<float>  & sys_trig();
