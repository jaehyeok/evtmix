...
float  const & small_tree_full::eff_trig() const{
  if(!read_only_){
    throw std::logic_error("Trying to write to const tree.");
  }
...
float  const & small_tree_full::w_btag() const{
  if(!read_only_){
    throw std::logic_error("Trying to write to const tree.");
  }
...
float  const & small_tree_full::w_fs_lep() const{
  if(!read_only_){
    throw std::logic_error("Trying to write to const tree.");
  }
...
float  const & small_tree_full::w_isr() const{
  if(!read_only_){
    throw std::logic_error("Trying to write to const tree.");
  }
...
float  const & small_tree_full::w_lep() const{
  if(!read_only_){
    throw std::logic_error("Trying to write to const tree.");
  }
...
float  const & small_tree_full::w_lumi() const{
  if(!read_only_){
    throw std::logic_error("Trying to write to const tree.");
  }
...
float  const & small_tree_full::w_pu() const{
  if(!read_only_){
    throw std::logic_error("Trying to write to const tree.");
  }
  if(!c_w_pu_ && b_w_pu_){
...
float  const & small_tree_full::w_toppt() const{
  if(!read_only_){
    throw std::logic_error("Trying to write to const tree.");
  }
...
std::vector<bool>  const & small_tree_full::sys_pass() const{
  if(!read_only_){
    throw std::logic_error("Trying to write to const tree.");
  }
...
std::vector<float>  const & small_tree_full::sys_bctag() const{
  if(!read_only_){
    throw std::logic_error("Trying to write to const tree.");
  }
...
std::vector<float>  const & small_tree_full::sys_fs_bctag() const{
  if(!read_only_){
    throw std::logic_error("Trying to write to const tree.");
  }
...
std::vector<float>  const & small_tree_full::sys_fs_lep() const{
  if(!read_only_){
    throw std::logic_error("Trying to write to const tree.");
  }
...
std::vector<float>  const & small_tree_full::sys_fs_udsgtag() const{
  if(!read_only_){
    throw std::logic_error("Trying to write to const tree.");
  }
...
std::vector<float>  const & small_tree_full::sys_ht() const{
  if(!read_only_){
    throw std::logic_error("Trying to write to const tree.");
  }
...
std::vector<float>  const & small_tree_full::sys_isr() const{
  if(!read_only_){
    throw std::logic_error("Trying to write to const tree.");
  }
...
std::vector<float>  const & small_tree_full::sys_lep() const{
  if(!read_only_){
    throw std::logic_error("Trying to write to const tree.");
  }
...
std::vector<float>  const & small_tree_full::sys_met() const{
  if(!read_only_){
    throw std::logic_error("Trying to write to const tree.");
  }
...
std::vector<float>  const & small_tree_full::sys_mj() const{
  if(!read_only_){
    throw std::logic_error("Trying to write to const tree.");
  }
...
std::vector<float>  const & small_tree_full::sys_mj14() const{
  if(!read_only_){
    throw std::logic_error("Trying to write to const tree.");
  }
...
std::vector<float>  const & small_tree_full::sys_mt() const{
  if(!read_only_){
    throw std::logic_error("Trying to write to const tree.");
  }
...
std::vector<float>  const & small_tree_full::sys_muf() const{
  if(!read_only_){
    throw std::logic_error("Trying to write to const tree.");
  }
...
std::vector<float>  const & small_tree_full::sys_mur() const{
  if(!read_only_){
    throw std::logic_error("Trying to write to const tree.");
  }
...
std::vector<float>  const & small_tree_full::sys_murf() const{
  if(!read_only_){
    throw std::logic_error("Trying to write to const tree.");
  }
...
std::vector<float>  const & small_tree_full::sys_pdf() const{
  if(!read_only_){
    throw std::logic_error("Trying to write to const tree.");
  }
...
std::vector<float>  const & small_tree_full::sys_st() const{
  if(!read_only_){
    throw std::logic_error("Trying to write to const tree.");
  }
...
std::vector<float>  const & small_tree_full::sys_trig() const{
  if(!read_only_){
    throw std::logic_error("Trying to write to const tree.");
  }
...
std::vector<float>  const & small_tree_full::sys_udsgtag() const{
  if(!read_only_){
    throw std::logic_error("Trying to write to const tree.");
  }
...
std::vector<float>  const & small_tree_full::w_pdf() const{
  if(!read_only_){
    throw std::logic_error("Trying to write to const tree.");
  }
...
std::vector<int>  const & small_tree_full::sys_nbm() const{
  if(!read_only_){
    throw std::logic_error("Trying to write to const tree.");
  }
...
std::vector<int>  const & small_tree_full::sys_njets() const{
  if(!read_only_){
    throw std::logic_error("Trying to write to const tree.");
  }
...
float  & small_tree_full::eff_trig(){
...
float  & small_tree_full::w_fs_lep(){
...
std::vector<bool>  & small_tree_full::sys_pass(){
...
std::vector<float>  & small_tree_full::sys_bctag(){
...
std::vector<float>  & small_tree_full::sys_fs_bctag(){
...
std::vector<float>  & small_tree_full::sys_fs_lep(){
...
std::vector<float>  & small_tree_full::sys_fs_udsgtag(){
...
std::vector<float>  & small_tree_full::sys_ht(){
...
std::vector<float>  & small_tree_full::sys_isr(){
...
std::vector<float>  & small_tree_full::sys_lep(){
...
std::vector<float>  & small_tree_full::sys_met(){
...
std::vector<float>  & small_tree_full::sys_mj(){
...
std::vector<float>  & small_tree_full::sys_mj14(){
...
std::vector<float>  & small_tree_full::sys_mt(){
...
std::vector<float>  & small_tree_full::sys_muf(){
...
std::vector<float>  & small_tree_full::sys_mur(){
...
std::vector<float>  & small_tree_full::sys_murf(){
...
std::vector<float>  & small_tree_full::sys_pdf(){
...
std::vector<float>  & small_tree_full::sys_st(){
...
std::vector<float>  & small_tree_full::sys_trig(){
...
std::vector<float>  & small_tree_full::sys_udsgtag(){
...
std::vector<float>  & small_tree_full::w_pdf(){
...
std::vector<int>  & small_tree_full::sys_nbm(){
...
std::vector<int>  & small_tree_full::sys_njets(){
